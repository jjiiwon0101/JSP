					...
					<td colspan="5" align="center">
                     ...
                     <c:if test="${pc.prev}">
	                        <li class="page-item"><a class="page-link"
	                           ...
	                           style="background-color: #9999FF; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">이전</a>
	                        </li>                    
                     </c:if>
                    	...
                    	<%-- 페이지 버튼 --%>
 						<c:forEach var="pageNum" begin="${pc.beginPage}" end ="${pc.endPage}">
	                        ...
	                        <a href="/MyWeb/list.board?page=${pageNum}&cpp=${pc.paging.cpp}" class="page-link"
	                           style="margin-top: 0; height: 40px; color: gray; border: 1px solid #9999FF; ${pageNum == pc.paging.page ? 'background-color: #CCCCFF' : ''}">${pageNum}</a>
	                        </li>				
 						</c:forEach>
    					...
    					<c:if test="${pc.next}">
	                        <li class="page-item"><a class="page-link"
	                           ...
	                           style="background-color: #9999FF; margin-top: 0; height: 40px; color: white; border: 0px solid #9999FF; opacity: 0.8">다음</a>
	                        </li>
    					</c:if>
