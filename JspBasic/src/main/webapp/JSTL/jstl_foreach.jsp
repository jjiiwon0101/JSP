...
<body>
	...
	<c:forEach var="i" begin="1" end="100" step="1">
		<c:set var="total" value="${total + i}" /> <%--기존 값 지목 --%>
	</c:forEach>
	...
	<c:forEach var="hang" begin="1" end="9" > <%-- step 생략 시 자동으로 1로 처리됨. --%>
		4 x ${hang} = ${4*hang} <br>
	</c:forEach>
	<hr>
	...
	<c:set var="list" value="<%=Arrays.asList("가", "나", "다", "라") %>"></c:set>
